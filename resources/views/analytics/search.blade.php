...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Search Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-neutral-900 mb-4">Search</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
            <form id="search-form" class="space-y-4">
                <div class="flex space-x-4">
                    ...
                    <div>
                        <select id="search-type" name="type" class="px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500">
    ...
    <div id="search-results" class="space-y-6">
        ...
        <div id="results-container">
            ...
            <!-- Smart Suggestions -->
            <div class="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
                <h3 class="text-lg font-semibold text-neutral-900 mb-4">Smart Suggestions</h3>
    ...
    <div id="filters-sidebar" class="hidden fixed inset-y-0 right-0 w-80 bg-white shadow-lg z-50 overflow-y-auto">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <button id="close-filters" class="text-neutral-400 hover:text-neutral-600">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayResults(data) {
        if (data.total === 0) {
            resultsContainer.innerHTML = `
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-neutral-900 mb-2">No results found</h3>
        ...
        let html = `<div class="mb-4 text-sm text-neutral-600">Found ${data.total} results</div>`;
    ...
    function renderRoomResults(rooms) {
        ...
        let html = '<div class="bg-white rounded-lg shadow-sm border border-neutral-200 mb-6">';
        html += '<div class="px-6 py-4 border-b border-neutral-200"><h3 class="text-lg font-semibold text-neutral-900">Rooms</h3></div>';
        html += '<div class="divide-y divide-neutral-200">';
    ...
    function renderNoteResults(notes) {
        ...
        let html = '<div class="bg-white rounded-lg shadow-sm border border-neutral-200 mb-6">';
        html += '<div class="px-6 py-4 border-b border-neutral-200"><h3 class="text-lg font-semibold text-neutral-900">Notes</h3></div>';
        html += '<div class="divide-y divide-neutral-200">';
    ...
    function renderRecordingResults(recordings) {
        ...
        let html = '<div class="bg-white rounded-lg shadow-sm border border-neutral-200 mb-6">';
        html += '<div class="px-6 py-4 border-b border-neutral-200"><h3 class="text-lg font-semibold text-neutral-900">Recordings</h3></div>';
        html += '<div class="divide-y divide-neutral-200">';
    ...
    function renderRoomItem(room) {
        return `
            <div class="px-6 py-4 hover:bg-neutral-50">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h4 class="font-medium text-neutral-900">${room.title}</h4>
                            <p class="text-sm text-neutral-600">${room.description || 'No description'}</p>
                            <div class="flex items-center space-x-4 mt-1 text-xs text-neutral-500">
                                ...
                                ${room.category ? `<span class="bg-neutral-100 px-2 py-1 rounded">${room.category}</span>` : ''}
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-2 mb-2">
                            <h4 class="font-medium text-neutral-900">${note.title}</h4>
                            <span class="bg-neutral-100 text-neutral-800 px-2 py-1 rounded text-xs">${note.note_type}</span>
                            ${note.is_pinned ? '<span class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-xs">Pinned</span>' : ''}
                        </div>
                        <div class="text-sm text-neutral-600 mb-2">${note.content_excerpt}</div>
            ...
            <div class="px-6 py-4 hover:bg-neutral-50">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h4 class="font-medium text-neutral-900">${recording.title}</h4>
    ...
    function displaySuggestions(suggestions) {
        ...
        const html = suggestions.map(suggestion => `
            <div class="border rounded-lg p-4 hover:bg-neutral-50 transition-colors">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h4 class="font-medium text-neutral-900 mb-1">${suggestion.title}</h4>
                        <p class="text-sm text-neutral-600 mb-2">${suggestion.description}</p>
