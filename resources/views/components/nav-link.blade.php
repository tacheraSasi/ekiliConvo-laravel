...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-brand-primary dark:border-brand-primary text-sm font-medium leading-5 text-gray-900 dark:text-slate-100 focus:outline-none focus:border-brand-secondary transition duration-150 ease-in-out'
