...
$classes = ($active ?? false)
            ...
            : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-neutral-600 dark:text-slate-400 hover:text-neutral-800 dark:hover:text-slate-200 hover:bg-neutral-50 dark:hover:bg-slate-700 hover:border-brand-primary/50 dark:hover:border-brand-primary/50 focus:outline-none focus:text-neutral-800 dark:focus:text-slate-200 focus:bg-neutral-50 dark:focus:bg-slate-700 focus:border-brand-primary/50 dark:focus:border-brand-primary/50 transition duration-150 ease-in-out';
@endphp
